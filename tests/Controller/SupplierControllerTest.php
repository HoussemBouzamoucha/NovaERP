...
final class SupplierControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'supplier[contactInfo]' => 'Testing',
            'supplier[email]' => 'Testing',
            'supplier[phoneNumber]' => 'Testing',
            'supplier[adress]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setContactInfo('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'supplier[contactInfo]' => 'Something New',
            'supplier[email]' => 'Something New',
            'supplier[phoneNumber]' => 'Something New',
            'supplier[adress]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getContactInfo());
