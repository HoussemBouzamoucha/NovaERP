 ...
 */
final class Version20251030165050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client RENAME COLUMN address TO address');
        ...
        $this->addSql('ALTER TABLE supplier RENAME COLUMN address TO address');
    }
