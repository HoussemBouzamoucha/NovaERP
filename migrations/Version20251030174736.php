 ...
 */
final class Version20251030174736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users DROP CONSTRAINT fk_users_project');
        $this->addSql('DROP INDEX IDX_1483A5E9166D1F9C');
        $this->addSql('ALTER TABLE users DROP project_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD project_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE users ADD CONSTRAINT fk_users_project FOREIGN KEY (project_id) REFERENCES project (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE INDEX IDX_1483A5E9166D1F9C ON users (project_id)');
